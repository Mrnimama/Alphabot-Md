exports.private = () =>{
	return`මෙය භාවිතා කළ හැක්කේ පුද්ගලික කතාබස් වල පමණි`
	}
exports.wait = () => {
    return `⏳ කරුනාකර රැදී සිටින්න !`
}
exports.ok = () => {
    return `✅ සාර්තකව සිදු කරන ලදි ☃`
}

exports.err = () => {
    return `⚠️ දෝශ විශේශාන්ග`
}
exports.erorLink = () => {
    return `⚠️ LINK ERROR `
}
...
exports.replyImg = (prefix, command) => {
    return `Caption එක ලෙස හෝ ජායාරූපය mention කරන්න ! ${prefix + command}`
}

exports.wrongFormat = (prefix) => {
    return `දැමූ ආකාරය වැරදී ❎ මෙය දමා නිවැරදි ආකාරයට දමන ආකාරය ඉගෙන ගන්න  *${prefix}allmenu*. 😒`
}
...
exports.cmdNotFound = (cmd, prefix) => {
    return `❎ Command *${cmd}* මෙවැනි කමාන්ඩ් එකක් සොයාගත නොහැක  *${prefix}allmenu*`
}

exports.ownerOnly = () => {
    return `❎ අයිතිකරුට පමනක් අයත් කමාන්ඩ් එකකි `
}

exports.doneOwner = () => {
    return `✅  ️එය සිදුකර අවසන් owner`
}

exports.groupOnly = () => {
    return `👥 මෙම කාමාන්ඩ් එක බාවිතාකර හැක්කේ Group  එකේ පමණි !`
}

exports.adminOnly = () => {
    return `මෙම කමාන්ඩ් එක Admin only  කමාන්ඩ් එකකි!`
}

exports.nhFalse = () => {
    return `මෙය වලංගු නොවේ !`
}
...
exports.notAdmin = () => {
    return `❎ ඇඩ්මින් කෙනෙකු නොවේ !❎`
}

exports.adminAlready = () => {
    return `❎ ඇඩ්මින් කෙනෙකු නැවත් ඇඩ්මින් කෙනෙකු කර නොහැක 😒`
}

exports.botNotAdmin = () => {
    return `මුලින්ම bot admin කෙනෙක් කරන්න! 🤔`
}

exports.received = (pushname) => {
    return `
Halo ${pushname}!
වාර්තා කිරීමට ස්තූතියි, අපට ඉක්මනින් වාර්තාව ලැබෙනු ඇත.`
}

exports.videoLimit = () => {
    return `මෙහි ප්‍රමානය ඉතාවිශාලයි !`
}

exports.notNum = (q) => {
    return `"${q}", මෙය ඉලක්කමක් නොවේ !`
}
exports.menunya = (salam, pushname, botname) =>{
	return` *Hi 💞...* ${pushname} සුභ පැතුම් ${සුබ පැතුම්} ,
 i ${botname}, මෙම බොට් යනු ඔබට ඉතාපහසුවෙන් බාවිතා කර හැකි බොට්  වේ.
 ඔබ යම් ආකාරයක දෝෂයක් හෝ දෝෂයක් සොයා ගන්නේ නම්, කරුණාකර තේරුම් ගන්න.
 අයිතිකරුට වාර්තා කරන්න එය නිවැරදි කිරීමට කටයුතු කරනු ඇත 🙏     
`
}
...
1. මෙය තුල ගෲප් ලින්ක් කිසිවක් නොදමන්න 
➽ ඉවත් කරනු ලැබේ

 2. බොට් අමතන්න එපා.  ️
 ➽ බ්ලොක් කරනු ලැබේ

 3. ❌ අවසර නොලත් කිසිවක් නොකරන්න ❌
⦁ අසභ්‍ය දර්ශන දැමීම 
⦁ nima add නොකරන බොට්ලා සම්බන්ධ වීම 
⦁ කරදර කාරී ලෙස එකම බටන් එබීම
⦁ තවත් ඒවා...
➽ ඉවත් කරනු ලැබේ

 ️ ප්‍රතිචාර දැක්වීමට බොට් පරක්කු වේද
 ️ ජාලය, සින්ග්නල් , Whatsapp මගින් නම්බර් බෑන් කිරිම  සහ අහඹු ලෙස බලපෑම් ඇති විය හැක.  දිගටම නීති පිළිපදින්න‼️


═══════════
*සින්දු වීඩියෝ Download  කරන්න තේරෙන්නෙ නැත්තම් පහල වීඩියෝ එක බලන්න*
https://youtu.be/cvj3054O5NU
 ...
 ️
*මාගේ රූල්ස් පිලිපදින්න*`
}
exports.welcome = () =>{
	return`HI I AM NIMA OFC BOT
	
මගෙන් සින්දු වීඩියෝ Download  කරන්න දන්නේ නැත්තම් 
මේ වීඩියෝ එක බලල එන්න.
☃
*⎝ɴɪᴍᴀ ʏᴛ ᴄʜᴀɴᴀʟ⎠*
